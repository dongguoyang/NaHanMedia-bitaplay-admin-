      ...
      <el-main>
        <el-card class="box-card">
          ...
          >
            ...
            <el-table-column prop="provider_id" label="软件商ID" min-width="150"></el-table-column>
            <el-table-column label="软件商手机号" min-width="150">
...
<script>
import {getProviderFinanceWithdraw, doProviderFinanceWithdraw} from "@/api/providerFinance";
...
export default {
  ...
  methods: {
    getList() {
      ...
      getProviderFinanceWithdraw(this.table.query).then(({code, data}) => {
    ...
    doWithdraw() {
      ...
      doProviderFinanceWithdraw(this.editDialog.data).then(({code}) => {
