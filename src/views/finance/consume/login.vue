...
<script>
import {getProviderFinanceRechargeLogin} from "@/api/providerFinance";
...
export default {
  ...
  methods: {
    getList() {
      ...
      getProviderFinanceRechargeLogin(this.table.query).then(({code, data}) => {
